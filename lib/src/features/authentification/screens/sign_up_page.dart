...
import 'package:flutter_application_1/src/features/authentification/screens/login_page.dart';
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text("Hi friend".toUpperCase(), style: Theme.of(context).textTheme.headlineLarge,),
